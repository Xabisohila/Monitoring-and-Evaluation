<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="pageClusterWG.aspx.cs" Inherits="pageClusterWG" %>
          ...
          <!-- Heading -->
            ...
            <div class="row">  
               ...
               <%-- <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                ...
                <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="pageInterventionDetails.aspx?id=1" class="portfolio-link">
                ...
                <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="pagePlanningOverview.aspx" class="portfolio-link">
                ...
                <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="pageMonitoringOverview.aspx" class="portfolio-link">
