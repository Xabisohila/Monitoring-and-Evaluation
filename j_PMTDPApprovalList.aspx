<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="j_PMTDPApprovalList.aspx.cs" Inherits="j_PMTDPApprovalList" %>
...
<div class="container">
    <div class="section-title text-center">
        <br />
        <div>
            <h2 class="background double animated wow fadeInUp color1" style="color: #000000;" data-wow-delay="0.2s"><span><strong>Pending PMTDP Approvals</strong></span></h2>
        </div>
    </div>
    <br /><br />
...
<%--<h2>Pending PMTDP Approvals</h2>--%>

<asp:GridView ID="gvUploads" runat="server" AutoGenerateColumns="false">
    <Columns>
        <asp:BoundField DataField="UploadRequestID" HeaderText="Request ID" />
        <asp:BoundField DataField="UploadDate" HeaderText="Date" />
        <asp:TemplateField>
            <ItemTemplate>
                <a href='<%# "j_PMTDPApprovalView.aspx?id=" + Eval("UploadRequestID") %>'>
                    Review
                </a>
            </ItemTemplate>
        </asp:TemplateField>
