<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="ii_ChangeRequests.aspx.cs" Inherits="ii_ChangeRequests" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        ...
        asp\:checkbox, input[type="checkbox"] { margin-left: 10px; margin-top: 12px; }
        ...
        .filter-controls { margin-bottom: 18px; display: flex; align-items: center; gap: 12px; flex-wrap: wrap; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="section-title text-center">
            <br />
            <div>
                <h2 class="background double animated wow fadeInUp color1" style="color: #000000;" data-wow-delay="0.2s"><span><strong>Manage Change Requests</strong></span></h2>
            </div>
        </div>
        <br /><br />
        ...
        <div class="filter-controls">
            ...
            <asp:CheckBox runat="server" ID="chkOnlyUnresolved" Text="Only Unresolved" AutoPostBack="true" OnCheckedChanged="chkOnlyUnresolved_CheckedChanged" />
        </div>

        <asp:GridView runat="server" ID="gvCR" AutoGenerateColumns="false" DataKeyNames="ChangeRequestID" OnRowCommand="gvCR_RowCommand">
            <Columns>
                <asp:BoundField DataField="ChangeRequestID" HeaderText="ID" Visible="false" />
                ...
                <asp:BoundField DataField="RequestDate" HeaderText="Date" DataFormatString="{0:yyyy-MM-dd HH:mm}" />
                <asp:CheckBoxField DataField="IsResolved" HeaderText="Resolved?" />
                <asp:TemplateField HeaderText="Actions">
                    <ItemTemplate>
                        <asp:LinkButton runat="server" CommandName="MarkResolved" CommandArgument='<%# Eval("ChangeRequestID") %>' Text="Mark Resolved" />
                        &nbsp;|&nbsp;
                        <asp:HyperLink runat="server" NavigateUrl='<%# "~/ReportView.aspx?reportId=" + Eval("ReportID") %>' Text="View Report" />
                    </ItemTemplate>
                </asp:TemplateField>
            </Columns>
        </asp:GridView>
