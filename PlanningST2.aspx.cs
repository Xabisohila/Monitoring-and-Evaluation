...
public partial class PlanningST2 : System.Web.UI.Page
{
    ...
    public void LoadPlanningData()
    {
        ...
        if ((string)Session["StrategicPriority"] == "4")
        {
            lblFocusArea1.Text = "Comprehensive social security system";
            lblFocusArea2.Text = "Increased access to quality early childhood development (ecd) services and support";
            lblFocusArea3.Text = "Spatial transformation through multi-programme integration in priority development areas";
            lblFocusArea4.Text = "Adequate housing and improved quality living environments  ";
            lblFocusArea5.Text = "Not Stated...";
            lblFocusArea7.Text = "Universal access to good quality health care for all South Africans achieved   ";
            lblFocusArea8.Text = "Improved schoolreadiness of children (SOPA & EXCO Lekgotla)  ";
            lblFocusArea9.Text = "Comprehensive social security system";
            lblFocusArea10.Text = "Increased access to quality early childhood development (ecd) services and support ";
            lblFocusArea10.Text = "Shared national spatial vision and frames to support integration between sector departments, provinces and regions ";
        ...
        else if ((string)Session["StrategicPriority"] == "7")
        {
    ...
    protected void populateFocusArea1()
    {
        try
        {
            gvIntervention1.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 6,  Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea2()
    {
        try
        {
            gvFocusArea2.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 7, Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea3()
    {
        try
        {
            gvFocusArea3.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]),8,  Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea4()
    {
        try
        {
            gvFocusArea4.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]),9,  Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea5()
    {
        try
        {
            gvFocusArea5.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 10, Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea6()
    {
        try
        {
            gvFocusArea6.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 11, Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea7()
    {
        try
        {
            gvFocusArea7.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 13,  Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea8()
    {
        try
        {
            gvFocusArea8.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 14,  Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea9()
    {
        try
        {
            gvFocusArea9.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 15, Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea10()
    {
        try
        {
            gvFocusArea10.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 16, Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea11()
    {
        try
        {
            gvFocusArea11.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 17, Convert.ToInt16(Session["StrategicPriority"]));
