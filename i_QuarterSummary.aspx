<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="i_QuarterSummary.aspx.cs" Inherits="i_QuarterSummary" %>
...
<%--<%@ Page Language="C#" AutoEventWireup="true" CodeFile="QuarterSummary.aspx.cs" Inherits="QuarterSummary" %>
<!DOCTYPE html>
<html>
...
<form id="form1" runat="server">--%>
    ...
    <div class="container">
        <div class="section-title text-center">
            <br />
            <div>
                <h2 class="background double animated wow fadeInUp color1" style="color: #000000;" data-wow-delay="0.2s"><span><strong>Quarter Summary</strong></span></h2>
            </div>
        </div>
        <br />
        <br />
        ...
        <div>
            ...
            <asp:Label runat="server" ID="lblAchieved" />
            &nbsp;|&nbsp;
        <strong>Not Achieved:</strong>
            <asp:Label runat="server" ID="lblNotAchieved" />
            &nbsp;|&nbsp;
