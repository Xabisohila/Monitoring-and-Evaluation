...
public partial class pagePlanningOverview : System.Web.UI.Page
{
    ...
    {
        int selectedClusterId       = Session["Cluster_ID"]        != null ? Convert.ToInt32(Session["Cluster_ID"])        : 0;
        int selectedWorkGroupId     = Session["ddlWorkingGroupID"] != null ? Convert.ToInt32(Session["ddlWorkingGroupID"]) : 0;
        int selectedPMTDPPriorityId = Session["PMTDP_PriorityID"] != null ? Convert.ToInt32(Session["PMTDP_PriorityID"]) : 0;
        int selectedFinancialYearId = Session["FY_ID"]             != null ? Convert.ToInt32(Session["FY_ID"])             : 0;
