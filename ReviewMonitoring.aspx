...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <style type="text/css">
        .status-green { background-color: #d4edda; }z
...
<asp:DropDownList ID="ddlCluster" runat="server" AutoPostBack="true" OnSelectedIndexChanged="ddlCluster_SelectedIndexChanged" CssClass="asp-dropdown" />
    ...
    <asp:GridView ID="gvReports" runat="server" AutoGenerateColumns="False" CssClass="table" OnRowDataBound="gvReports_RowDataBound">
        <Columns>
            ...
            <%-- Pseudocode:
            1. Replace the HyperLinkField with a TemplateField.
            2. In the ItemTemplate, add an asp:HyperLink control.
            3. Bind NavigateUrl to Eval("UploadFilePath").
            4. Set Text to the literal "View".
            5. Bind Visible to whether UploadFilePath is not null or empty:
               Visible = !String.IsNullOrEmpty(Convert.ToString(Eval("UploadFilePath")))
            6. Result: show "View" (link opens in new tab) when document exists; show nothing when no document.
            --%>
            <asp:TemplateField HeaderText="Document">
              <ItemTemplate>
                <asp:HyperLink ID="lnkDocument" runat="server"
                               Text="View"
                               NavigateUrl='<%# Eval("UploadFilePath") %>'
                               Target="_blank"
                               Visible='<%# !String.IsNullOrEmpty(Convert.ToString(Eval("UploadFilePath"))) %>' />
              </ItemTemplate>
            </asp:TemplateField>
...
<asp:Chart ID="PerformanceChart" runat="server" Width="700px" Height="400px" Visible="false">
  <ChartAreas>
