<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="pageAddPOA.aspx.cs" Inherits="pageAddPOA" %>
...
<div class="container" style="padding-bottom:60px; max-width:820px;">
    ...
    <div class="ai-header">
        ...
        <h2>Add New Programme of Action</h2>
        <p>Complete the form below to add a Programme of Action to the selected PMTDP Priority.</p>
    </div>
    ...
    <%-- SECTION 1: PMTDP Plan & Cluster --%>
    <div class="form-card">
        <div class="card-title">PMTDP Plan</div>

        <div class="field">
            <label for="<%= ddlPDP.ClientID %>">PMTDP Plan</label>
            <asp:DropDownList ID="ddlPDP" runat="server"
                AutoPostBack="true"
                OnSelectedIndexChanged="ddlPDP_SelectedIndexChanged">
                <asp:ListItem Text="-- Select PMTDP --" Value="0" />
            </asp:DropDownList>
            <asp:RequiredFieldValidator ID="rfvPDP" runat="server"
                ControlToValidate="ddlPDP" InitialValue="0"
                ErrorMessage="PMTDP Plan is required."
        ...
        <div class="two-col">
            <div class="field">
                ...
                <asp:DropDownList ID="ddlCluster" runat="server"
                    ...
                    <asp:ListItem Text="-- Select Cluster --" Value="0" />
                </asp:DropDownList>
            ...
            <div class="field">
                <label for="<%= ddlPriority.ClientID %>">PMTDP Priority</label>
                <asp:DropDownList ID="ddlPriority" runat="server">
                    <asp:ListItem Text="-- Select PMTDP Priority --" Value="0" />
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfv_ddlPriority" runat="server"
                    ControlToValidate="ddlPriority" InitialValue="0"
                    ErrorMessage="PMTDP Priority is required."
                    Display="Dynamic" CssClass="val-msg" />
            </div>
        </div>
    </div>

    <%-- SECTION 2: POA Details --%>
    <div class="form-card">
        <div class="card-title">POA Details</div>

        <div class="field">
            <label for="<%= txtPOAName.ClientID %>">POA Name</label>
            <asp:TextBox ID="txtPOAName" runat="server" />
            <asp:RequiredFieldValidator ID="rfvPOAName" runat="server"
                ControlToValidate="txtPOAName"
                ErrorMessage="POA Name is required."
                Display="Dynamic" CssClass="val-msg" />
        </div>

        <div class="field">
            <label for="<%= txtPOADescription.ClientID %>">
                Description <span class="opt">(optional)</span>
            </label>
            <asp:TextBox ID="txtPOADescription" runat="server" TextMode="MultiLine" />
        </div>

        <div class="field">
            <label for="<%= txtDesiredOutcome.ClientID %>">
                Desired Outcome <span class="opt">(optional)</span>
            </label>
            <asp:TextBox ID="txtDesiredOutcome" runat="server" TextMode="MultiLine" />
        </div>
    </div>
    ...
    <div class="form-card">
        ...
        <div class="two-col">
            <div class="field">
                <label for="<%= ddlStartYear.ClientID %>">Start Year</label>
                <asp:DropDownList ID="ddlStartYear" runat="server">
                    <asp:ListItem Text="-- Select Start Year --" Value="0" />
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfvStartYear" runat="server"
                    ControlToValidate="ddlStartYear" InitialValue="0"
                    ErrorMessage="Start Year is required."
                    Display="Dynamic" CssClass="val-msg" />
            </div>
            <div class="field">
                <label for="<%= ddlEndYear.ClientID %>">End Year</label>
                <asp:DropDownList ID="ddlEndYear" runat="server">
                    <asp:ListItem Text="-- Select End Year --" Value="0" />
                </asp:DropDownList>
                <asp:RequiredFieldValidator ID="rfvEndYear" runat="server"
                    ControlToValidate="ddlEndYear" InitialValue="0"
    ...
    <%-- Action buttons --%>
    <div class="btn-row">
        <asp:Button ID="btnSubmit" runat="server" Text="Add POA"
