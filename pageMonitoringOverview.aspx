<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="pageMonitoringOverview.aspx.cs" Inherits="pageMonitoringOverview" %>
...
        /*body { font-family: Arial, sans-serif; margin: 20px; background-color: #f4f4f4; color: #333; }*/
      ...
      .status-ontrack { color: green; font-weight: bold; }
      .status-delayed { color: orange; font-weight: bold; }
      .status-behind { color: red; font-weight: bold; }
      .status-nodata { color: gray; font-style: italic; }*/
