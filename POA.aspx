<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="POA.aspx.cs" Inherits="POA" %>
    ...
    <Panes>
        ...
        <AjaxControlToolkit:AccordionPane ID="AccordionPane2" runat="server">
            <Header>
                <a class="acordionLink" href="#">
                    <i class="fas fa-chevron-right accordion-icon"></i>
                    <asp:Label ID="Label5" runat="server" Text="Section Title" />
                </a>
            </Header>

            <Content>
                <asp:Label ID="Label6" runat="server" Text="This is the content of section 2." />
            </Content>
        </AjaxControlToolkit:AccordionPane>
