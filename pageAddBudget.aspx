<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="pageAddBudget.aspx.cs" Inherits="pageAddBudget" %>
...
<div class="container" style="padding-bottom:60px; max-width:820px;">
    ...
    <div class="ai-header">
        ...
        <p>Complete the form below to add a budget entry for the selected Intervention.</p>
    </div>
    ...
    <asp:Panel ID="pnlSuccess" runat="server" Visible="false">
        <div class="success-card">
            <div class="tick">&#10003;</div>
            <h3>Budget Entry Added Successfully</h3>
            <p>The budget entry has been saved. What would you like to do next?</p>
