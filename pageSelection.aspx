<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master"
    AutoEventWireup="true" CodeFile="pageSelection.aspx.cs" Inherits="pageSelection" %>
                    ...
                    <div style="padding-top: 30px" class="panel-body">
                        ...
                        <div id="loginform" class="form-horizontal" role="form">
                            <div style="margin-bottom: 25px" class="input-group">
                                ...
                                <asp:RadioButton ID="rbPlanning" runat="server" GroupName="MorE" Text="Planning" OnCheckedChanged="rbPlanning_CheckedChanged"  AutoPostBack="true" style="padding-right: 20px;"/>
