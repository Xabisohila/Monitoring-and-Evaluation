<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="ii_DeptQuarterlyTargetsUpload.aspx.cs" Inherits="ii_DeptQuarterlyTargetsUpload" %>
...
<div class="container">
    <div class="section-title text-center">
        <br />
        <div>
            <h2 class="background double animated wow fadeInUp color1" style="color: #000000;" data-wow-delay="0.2s"><span><strong>Department Quarterly Targets Upload</strong></span></h2>
        </div>
    </div>
    <br /><br />

 
  <%--<h2>Department Quarterly Targets Upload</h2>--%>
  <p>This page updates only Quarterly Targets (Q1–Q4). It never changes the Annual (POA) target.</p>
  ...
  <br />
  <asp:Button runat="server" ID="btnCommit" Text="Commit and Save" Visible="false" OnClick="btnCommit_Click" />
  <asp:Label runat="server" ID="lblMsg" />
  <br />
  <asp:Button runat="server" ID="btnDownloadTpl" Text="Download Template" OnClick="btnDownloadTpl_Click" />
