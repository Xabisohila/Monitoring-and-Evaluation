<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="i_ProgrammeAdmin.aspx.cs" Inherits="i_ProgrammeAdmin" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="container">
        <div class="section-title text-center">
            <br />
            <div>
                <h2 class="background double animated wow fadeInUp color1" style="color: #000000;" data-wow-delay="0.2s"><span><strong>Integration Programme - WG</strong></span></h2>
            </div>
        </div>
        <br /><br />
        ...
        <div class="search-box">
            <input type="text" id="searchInput" placeholder="Search programme..." onkeyup="filterTable()" style="width:400px"/>
        </div>
        ...
        <div>
            <asp:Label runat="server" Text="Programme Name:" AssociatedControlID="txtName" />
            <asp:RequiredFieldValidator runat="server" ControlToValidate="txtName" ErrorMessage="Programme name is required" ForeColor="Red"/>
            <asp:TextBox runat="server" ID="txtName" Width="400" /> 
        </div>

        <div>
            <asp:Label runat="server" Text="Leading Department:" AssociatedControlID="ddlLeaderDept" />
            <%--<small>(Optional)</small>--%>
            <asp:DropDownList runat="server" ID="ddlLeaderDept" />
        </div>
        ...
        <asp:GridView
            ...
            <Columns>
                <asp:BoundField DataField="ProgrammeID" HeaderText="ID" Visible="false" SortExpression="ProgrammeID" />
                <asp:BoundField DataField="ProgrammeName" HeaderText="Programme" SortExpression="ProgrammeName" />
                <asp:TemplateField HeaderText="Leading Department/Entity" SortExpression="LeaderDeptID">
                    <ItemTemplate>
                        <asp:Label runat="server" ID="lblDeptName" />
                        <asp:HiddenField runat="server" ID="hfDeptID" Value='<%# Eval("LeaderDeptID") %>' />
                    </ItemTemplate>
                </asp:TemplateField>
                <asp:TemplateField HeaderText="Institutions" ItemStyle-Width="120px">
                    <ItemTemplate>
                        <asp:HyperLink ID="lnkInstitutions" runat="server" 
                            NavigateUrl='<%# "i_ProgrammeInstitutions.aspx?ProgrammeID=" + Eval("ProgrammeID") %>'
                            CssClass="btn btn-info btn-sm">
                            <i class="glyphicon glyphicon-education"></i> Institutions
                        </asp:HyperLink>
                    </ItemTemplate>
                </asp:TemplateField>
