...
public partial class editPlanningST : System.Web.UI.Page
{
    ...
    protected void gvIntervention1_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Edit") // Replace "Edit" with your actual CommandName
        {
            ...
            Label txtBox = (Label)row.FindControl("txtKeyIndicatorFA1");
            Label txtBaseline_ = (Label)row.FindControl("txtFA1Baseline");

            Label txtAnnualTarget_ = (Label)row.FindControl("txtFA1AnnualTarget");

            Label txtQ1_ = (Label)row.FindControl("txtFA1Q1Planning");
            Label txtQ2_ = (Label)row.FindControl("txtFA1Q2Planning");
            Label txtQ3_ = (Label)row.FindControl("txtFA1Q3Planning");
            Label txtQ4_ = (Label)row.FindControl("txtFA1Q4Planning");

            Label txtTotal_ = (Label)row.FindControl("txtFA1Total");
