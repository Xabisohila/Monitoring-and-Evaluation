...
public partial class PlanningED : System.Web.UI.Page
{
    ...
    public void LoadPlanningData()
    {
        ...
        if ((string)Session["StrategicPriority"] == "2")
        {
            lblFocusArea1.Text = "Investing in inclusive economic growth;   Reduce concentration and monopolies and expanded small business sector";
            lblFocusArea2.Text = "Improve the quality and quantum of investment to support growth and job creation (8% Public Sector contribution and 15% Private Sector contribution)";
            lblFocusArea3.Text = "Sustainable Land reform ";
            lblFocusArea4.Text = "Agrarian Transformation";
        ...
        else if ((string)Session["StrategicPriority"] == "6")
        {
            lblFocusArea1.Text = "Investing in inclusive economic growth;   Reduce concentration and monopolies and expanded small business sector";
            lblFocusArea2.Text = "Improve the quality and quantum of investment to support growth and job creation (8% Public Sector contribution and 15% Private Sector contribution)";
            lblFocusArea3.Text = "Sustainable Land reform";
            lblFocusArea4.Text = "Provide AgriBusiness Support to Commercialization  of Agriculture Sector";
        ...
        else if ((string)Session["StrategicPriority"] == "8")
        {
            lblFocusArea1.Text = "Investing in inclusive economic growth;   Reduce concentration and monopolies and expanded small business sector";
            lblFocusArea2.Text = "Improve the quality and quantum of investment to support growth and job creation (8% Public Sector contribution and 15% Private Sector contribution)";
            lblFocusArea3.Text = "Sustainable Land reform";
            ...
            Session["FocusArea1"] = "25";
            Session["FocusArea2"] = "26";
            Session["FocusArea3"] = "27";
            Session["FocusArea4"] = "28";
            //Session["FocusArea5"] = "12";
            //Session["FocusArea6"] = "13";
            //Session["FocusArea7"] = "14";
            //Session["FocusArea8"] = "15";
    ...
    protected void populateFocusArea1()
    {
        try
        {
            gvIntervention1.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 25,  Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea2()
    {
        try
        {
            gvFocusArea2.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]), 26, Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea3()
    {
        try
        {
            gvFocusArea3.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]),27,  Convert.ToInt16(Session["StrategicPriority"]));
    ...
    protected void populateFocusArea4()
    {
        try
        {
            gvFocusArea4.DataSource = oMnERecord.Select_PlanningData(Convert.ToInt16(Session["Cluster"]),28,  Convert.ToInt16(Session["StrategicPriority"]));
