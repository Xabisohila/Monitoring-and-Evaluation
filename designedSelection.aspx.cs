...
public partial class designedSelection : System.Web.UI.Page
{
    ...
    private void PopulateDropdowns()
    {
        ...
        DataTable dtWorkGroups = repo.GetAllWorkGroupsLookup_2(Convert.ToInt32(Session["Cluster_ID"]));
        ...
        DataTable dtPMTDPPriorities = repo.GetAllPMTDPPrioritiesLookup_via_Cluster(Convert.ToInt32(Session["Cluster_ID"]));
                        ...
                        {                           
                            ...
                            if(value == "Monitoring")
                            {
                                if (ddlQuarter.SelectedItem.Value != "0")
                                {
                                    ...
                                    Response.Redirect("designedMonitoringOverview.aspx");
                            ...
                            else if(value == "Planning")
                            {
                                ...
                                Response.Redirect("designedPlanningOverview.aspx");
                            }
                            else
                            {
