<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="i_PriorityAdmin.aspx.cs" Inherits="i_PriorityAdmin" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        ...
        asp\:textbox, input[type="text"], textarea { display: block; width: 100%; max-width: 560px; padding: 9px 12px; border: 1px solid var(--border); border-radius: 8px; background: var(--surface); color: var(--text); transition: border-color .15s ease, box-shadow .15s ease; }
        asp\:textbox:focus, input[type="text"]:focus, textarea:focus { outline: none; border-color: var(--primary); box-shadow: 0 0 0 3px rgba(11,94,215,.15); }
        ...
        @media (max-width: 640px) { .page-wrap { padding: 12px; } asp\:textbox, input[type="text"], textarea { max-width: 100%; } table th, table td { padding: 8px 10px; font-size: 12px; } }
    </style>
</asp:Content>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="section-title text-center">
            <br />
            <div>
                <h2 class="background double animated wow fadeInUp color1" style="color: #000000;" data-wow-delay="0.2s"><span><strong>Strategic Priorities</strong></span></h2>
            </div>
        </div>
        <br /><br />
        ...
        <asp:Label runat="server" Text="Priority Name:" AssociatedControlID="txtName" />
        <asp:RequiredFieldValidator runat="server" ControlToValidate="txtName" ErrorMessage="Name required"  ForeColor="Red"/>
        <asp:TextBox runat="server" ID="txtName" />

        <asp:Label runat="server" Text="Description:" AssociatedControlID="txtDesc" />
        <asp:TextBox runat="server" ID="txtDesc" TextMode="MultiLine" Rows="3" />
        ...
        <asp:GridView
            ...
            <Columns>
                <asp:BoundField DataField="PriorityID" HeaderText="ID" Visible="false" SortExpression="PriorityID"/>
                <asp:BoundField DataField="PriorityName" HeaderText="Name" SortExpression="PriorityName" />
