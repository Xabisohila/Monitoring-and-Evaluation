<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="i_AnnualTargets.aspx.cs" Inherits="i_AnnualTargets" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="head" Runat="Server">
    <style type="text/css">
        ...
        asp\:validationsummary, .validation-summary-errors, .text-danger { display: block; margin-bottom: 10px; color: var(--danger); font-size: 13px; }
        ...
        #lblMsg { display: block; margin-bottom: 10px; padding: 10px 12px; border-radius: 8px; font-size: 14px; background: #d1ecf1; border: 1px solid #bee5eb; color: #0c5460; }
        .search-box { margin-bottom: 16px; }
        .search-box input[type="text"] { max-width: 400px; }
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        <div class="section-title text-center">
            <br />
            <div>
                <h2 class="background double animated wow fadeInUp color1" style="color: #000000;" data-wow-delay="0.2s"><span><strong>Annual Targets</strong></span></h2>
            </div>
        </div>
        <br /><br />
        ...
        <div class="search-box">
            <input type="text" id="searchInput" placeholder="Search annual targets..." onkeyup="filterTable()" style="width:400px"/>
        </div>
        ...
        <div>
            ...
            <asp:RequiredFieldValidator ControlToValidate="ddlIndicator" InitialValue="" ErrorMessage="Select an Indicator" runat="server" ForeColor="Red" />
        ...
        <div>
            ...
            <asp:RequiredFieldValidator ControlToValidate="ddlFY" InitialValue="" ErrorMessage="Select Financial Year" runat="server" ForeColor="Red" />
        ...
        <asp:GridView ID="gvAnnualTargets" runat="server" DataKeyNames="AnnualTargetID" OnRowCommand="gvAnnualTargets_RowCommand">
            <Columns>
                <asp:BoundField DataField="AnnualTargetID" HeaderText="ID" Visible="false" />
                <asp:BoundField DataField="IndicatorID" HeaderText="Indicator ID" />
    ...
    <script type="text/javascript">
        function filterTable() {
            ...
            var table = document.getElementById('<%= gvAnnualTargets.ClientID %>');
