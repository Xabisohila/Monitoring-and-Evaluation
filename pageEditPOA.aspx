<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="pageEditPOA.aspx.cs" Inherits="pageEditPOA" %>
...
<div class="container" style="padding-bottom:60px; max-width:820px;">
    ...
    <div class="ai-header">
        ...
        <h2>Edit Programme of Action</h2>
    ...
    <div class="form-card">
        <div class="card-title">Strategic Alignment</div>
        <div class="two-col">
            <div class="field">
                <label for="<%= ddlPMTDPPriority.ClientID %>">PMTDP Priority</label>
                <asp:DropDownList ID="ddlPMTDPPriority" runat="server" />
                <asp:RequiredFieldValidator ID="rfvPMTDPPriority" runat="server"
                    ControlToValidate="ddlPMTDPPriority" InitialValue="0"
    ...
    <div class="btn-row">
        <asp:Button ID="btnUpdate" runat="server" Text="Save Changes"
            ...
            OnClientClick="return showConfirm('<%= btnUpdate.UniqueID %>');" />
