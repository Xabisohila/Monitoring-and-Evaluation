<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="tempPlanningST.aspx.cs" Inherits="tempPlanningST" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
        ...
        <div class="container">
          <!-- Heading -->
           ...
           <panes>
               ...
               <AjaxControlToolkit:AccordionPane ID="AccordionPaneTemp" runat="server" ContentCssClass="" HeaderCssClass="">

                   <Header><a class="acordionLink" href="" style="color: white">
                       <asp:Label ID="Label4" runat="server" /></a> </Header>
                   <Content>
    ...
    <div class="container1">
            <div class="header1">Provincial Development Plan Goal 1</div>
            <div class="row1">
                <div class="cell1">Priority Focus</div>
                <div class="cell1">Economic Growth</div>
            </div>
        <%--    <div class="row">
                <div class="cell">Integration Programme</div>
                <div class="cell">Inclusive Economic Growth</div>
            </div>
            <div class="row">
                <div class="cell">Impact</div>
                <div class="cell">Sustainable and inclusive economic growth</div>
            </div>
            <div class="header">Implementation Details</div>
            <div class="row">
                <div class="cell">Desired Outcome</div>
                <div class="cell">Outcome Indicator</div>
                <div class="cell">Indicator Type</div>
                <div class="cell">Baseline 2019/2020</div>
                <div class="cell">Target 2030</div>
                <div class="cell">Implementing Institution</div>
            </div>
            <div class="row">
                <div class="cell">Innovation and inclusive growing economy</div>
                <div class="cell">GDP growth rate</div>
                <div class="cell">PDP 2030, NDP 2030, SDG 8</div>
                <div class="cell">1.5%</div>
                <div class="cell">5.4%</div>
                <div class="cell">DEDEAT</div>
            </div>--%>
        </div>
