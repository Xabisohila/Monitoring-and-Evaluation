<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="page1ClusterWG.aspx.cs" Inherits="pageClusterWG" %>
          ...
          <!-- Heading -->
            <div class="section-header">
                <div class="row section-title text-center">
                    ...
                    <br /><br /><br /><br /><br /><br />
                    <div class="row">
                    <h2 class="background double animated wow fadeInUp" data-wow-delay="0.2s"><span><strong> Cluster </strong> </span></h2>
                     </div>
            ...
            <div class="row">  
                ...
                <%--<div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="pageSelection.aspx?&cluster=1" class="portfolio-link" >
                ...
                <!-- Box-2 -->
                <%--<div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="pageSelection.aspx?&cluster=2" class="portfolio-link" >
                ...
                <!-- Box-3 -->
               <%-- <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="pageSelection.aspx?&cluster=3" class="portfolio-link" >
                ...
                <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="page1selection.aspx?&cluster=401" class="portfolio-link">
                ...
                <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="page1selection.aspx?&cluster=402" class="portfolio-link">
                ...
                <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="page1selection.aspx?&cluster=403" class="portfolio-link">
                ...
                <div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
                    <a href="page1selection.aspx?&cluster=404" class="portfolio-link">
                ...
                <!-- Box-4 -->
                <%--<div class="col-md-3 col-sm-6 portfolio-item wow zoomIn animated" data-wow-duration="1500ms" data-wow-delay="100ms">
    <a href="pageSelection.aspx?&cluster=4" class="portfolio-link" >
