<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="upload.aspx.cs" Inherits="upload" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="padding100">
        <div class="container">
     <div class="col-md-12">
                    <h2 class="background double animated wow fadeInUp" data-wow-delay="0.2s"><span><strong> POE </strong> </span></h2>
      </div>
                    ...
                    <div style="padding-top: 30px" class="panel-body">
                        ...
                        <div id="loginform" class="form-horizontal" role="form">
                            ...
                            <div style="margin-top: 10px" class="form-group">
                                <!-- Button -->
                                <div class="col-sm-12 controls">
                                    <asp:TextBox runat="server" ID="txtFileName" placeholder ="File Name (100 characters (max)" TextMode="MultiLine" CssClass="form-control" MaxLength="100"/>
                                </div>
                            </div>
            ...
            <div  class="col-md-6">
                <AjaxControlToolkit:BarChart ID="bcKeyIndicator" runat="server" ChartHeight="300" ChartWidth="450" Visible="false"
                            
                            ChartType="Column" ChartTitleColor="#0E426C" CategoryAxisLineColor="#D08AD9"
                            ValueAxisLineColor="#D08AD9" BaseLineColor="#A156AB" Width="500px" Height="321px">
