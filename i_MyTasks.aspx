<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="i_MyTasks.aspx.cs" Inherits="i_MyTasks" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <div class="container">
        ...
        <div class="form-grid">
            ...
            <asp:DropDownList runat="server" ID="ddlFY" AutoPostBack="true" OnSelectedIndexChanged="FiltersChanged" Width="200px" />
            ...
            <asp:Button runat="server" ID="btnRefresh" Text="Refresh" OnClick="btnRefreshClick" />
            <hr />

            <%--QA tasks (visible to QA roles only)--%>
            <asp:Panel runat="server" ID="pnlQA" Visible="true">
                <h3>Awaiting QA</h3>
                <asp:GridView runat="server" ID="gvQA" AutoGenerateColumns="true" OnRowCommand="gvQARowCommand">
                    <Columns>
            ...
            <asp:Panel runat="server" ID="pnlApproval" Visible="true">
                ...
                <asp:GridView runat="server" ID="gvApproval" AutoGenerateColumns="true" OnRowCommand="gvApprovalRowCommand">
                    <Columns>
            ...
            <asp:Panel runat="server" ID="pnlSignoff" Visible="true">
                <h3>Awaiting Sign-off</h3>
                <asp:GridView runat="server" ID="gvSignoff" AutoGenerateColumns="true" OnRowCommand="gvSignoffRowCommand">
                    <Columns>
            ...
            <asp:Panel runat="server" ID="pnlCorrections" Visible="true">
                ...
                <asp:GridView runat="server" ID="gvCorrections" AutoGenerateColumns="true"
                    DataKeyNames="ReportID"
                    OnRowCommand="gvCorrections_RowCommand">
                    <Columns>
                        <asp:TemplateField>
                            <ItemTemplate>
                                <asp:Button runat="server" CommandName="Open" Text="Fix & Resubmit"
