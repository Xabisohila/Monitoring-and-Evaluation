<%@ Page Title="" Language="C#" MasterPageFile="~/akshara.master" AutoEventWireup="true" CodeFile="lastPlanningST.aspx.cs" Inherits="lastPlanningST" %>
                ...
                <content>
                    ...
                    <style type="text/css">
                        ...
                        .containerNew {
                            ...
                            .containerNew .innerNew .inner-innerNew{
                                background-color: #f1f1f1;
                    ...
                    <asp:GridView ID="gvNew" runat="server" AutoGenerateColumns="False" BackColor="White" 
                        BorderStyle="None" BorderWidth="1px" CellPadding="3"  
                        HorizontalAlign="Left" Width="100%" Visible="false">
                        <Columns>

                            <asp:TemplateField HeaderText="Desired Indicator" ItemStyle-Width="250">
                                <ItemTemplate>
                                    <div class="containerNormal">
                                    <asp:LinkButton ID="lnkKeyIndicatorFA1" runat="server" Text='<%# Bind("KeyIndicator") %>' ForeColor="Blue" />
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Outcome Indicator" ItemStyle-Width="250">
                                <ItemTemplate>
                                    <div class="containerNormal">
                                        <asp:LinkButton ID="lnkKeyIndicatorFA1" runat="server" Text='<%# Bind("KeyIndicator") %>' ForeColor="Blue" />
                                    </div>
                            ...
                            <asp:TemplateField HeaderText="Indicator Type" ItemStyle-Width="250">
                                <ItemTemplate>
                                    <div class="containerNormal">
                                        <asp:LinkButton ID="lnkKeyIndicatorFA1" runat="server" Text='<%# Bind("KeyIndicator") %>' ForeColor="Blue" />
                                    </div>
                            ...
                            <asp:TemplateField HeaderText="PDP Fulfilment" ItemStyle-Width="250">
                                <ItemTemplate>
                                    <div class="containerNew">
                                        <div class="innerNew">
                                            <div class="inner-innerNew">3</div>
                                            <div class="inner-innerNew">3</div>
                                        </div>
                                    </div>
                                </ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Indicator2" ItemStyle-Width="250">
                                <ItemTemplate>
                                    <div class="containerNew">
                                        <%--<div>1</div>
                                        <div><asp:LinkButton ID="lnkKeyIndicatorFA1" runat="server" Text='<%# Bind("KeyIndicator") %>' ForeColor="Blue" /></div>
                                        <div class="innerNew">
                                            <div class="inner-innerNew">3</div>
                                            <div class="inner-innerNew">3</div>
                                            <%--<div class="inner-innerNew">3</div>--% >
                                        </div>--%>
                                        <div class="innerNew">4</div>
                                        <div class="innerNew">5</div>
                                        <div class="innerNew">6</div>
                                        <div class="innerNew">7</div>
                                        <div class="innerNew">8</div>
                                    </div>
                                </ItemTemplate>
                            </asp:TemplateField>

                           <%-- <asp:TemplateField HeaderText="Indicator3" ItemStyle-Width="250">
                                <ItemTemplate>
                                    <div class="containerNew">
                                        <div>1</div>
                                        <div>
                                            <asp:LinkButton ID="lnkKeyIndicatorFA1" runat="server" Text='<%# Bind("KeyIndicator") %>' ForeColor="Blue" /></div>
                                        <div class="innerNew">
                                            <div class="inner-innerNew">3</div>
                                            <div class="inner-innerNew">3</div>
                                            <div class="inner-innerNew">3</div>
...
<%--=============================================================================================================================--%>
                    ...
                    <asp:GridView ID="GridView1" Visible="false" runat="server" AutoGenerateColumns="False" OnRowDataBound="GridView1_RowDataBound">
                        <Columns>
                            <asp:TemplateField HeaderText="Category" ControlStyle-ForeColor="Black">
                                <ItemTemplate>
                                    <asp:Label ID="lblCategory" runat="server" Text='<%# Eval("Desired_Outcome") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Category1" ControlStyle-ForeColor="Black">
                                <ItemTemplate>
                                    <asp:Label ID="lblCategory1" runat="server" Text='<%# Eval("Outcome_Indicator") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                    ...
                    <asp:GridView ID="GridView2" runat="server" AutoGenerateColumns="False" Visible="true" ShowHeader="false">
    <Columns>
        <asp:TemplateField HeaderText="Details">
            <HeaderStyle HorizontalAlign="Center" />
            <ItemTemplate>
                <table border="1" style="width:1147px; text-align:left; color:black; background-color:#80BF64;">
                    <tr>
                        <%--<th>Column 1</th>
                        <th>Column 2</th>--%>
                        <%--<th>Column 3</th>--%>
                    ...
                    <tr>
                        ...
                        <td><strong><%# Eval("Row1Col1") %></strong></td>
                        <td><strong><%# Eval("Row1Col2") %></strong></td>
                        <%--<td><%# Eval("Row1Col3") %></td>--%>
                    </tr>
                    <tr>
                        <td><strong><%# Eval("Row2Col1") %></strong></td>
                        <td><strong><%# Eval("Row2Col2") %></strong></td>
                       <%-- <td><%# Eval("Row2Col3") %></td>--%>
                    </tr>
                    <tr>
                        <td><strong><%# Eval("Row3Col1") %></strong></td>
                        <td><strong><%# Eval("Row3Col2") %></strong></td>
                        <%--<td><%# Eval("Row3Col3") %></td>--%>
                    </tr>
                    <tr>
                        <td><strong><%# Eval("Row4Col1") %></strong></td>
                        <td><strong><%# Eval("Row4Col2") %></strong></td>
                        <%--<td><%# Eval("Row4Col3") %></td>--%>
                    </tr>
                </table>
            </ItemTemplate>
...
<%--<asp:Literal ID="litOutcome" runat="server" Mode="PassThrough" />--%>



                    <%--OnRowCreated="gvIntervention1_RowCreated"--%>
                    
                    <asp:GridView ID="gvIntervention1" runat="server" AutoGenerateColumns="False" BackColor="White" BorderStyle="None" BorderWidth="1px" CellPadding="3" OnDataBound="gvIntervention1_DataBound" HorizontalAlign="Left" Width="100%"
                         ShowHeader="false" Font-Size="11px" OnRowDataBound="gvIntervention1_RowDataBound" OnRowCreated="gvIntervention1_RowCreated">
                        <Columns>



                            <asp:TemplateField HeaderText="Desired Outcome">
                                <HeaderStyle CssClass="center-header" />
                                <ItemTemplate>
                                    <%--<asp:Literal ID="Desired_Outcome_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Desired_Outcome") %>' />--%>
                            ...
                            <asp:TemplateField HeaderText="Outcome Indicator">
                                <ItemTemplate>
                                    <%--<asp:Literal ID="Outcome_Indicator_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Outcome_Indicator") %>' />--%>

                                    <asp:Label ID="Outcome_Indicator_Id1" runat="server" Text='<%# Eval("Outcome_Indicator") %>'></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Indicator Type">
                                <ItemTemplate>
                                    <asp:Literal ID="Indicator_Type_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Indicator_Type") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="PDP Fulfilment: Baseline 2019/2020">
                                <ItemTemplate>
                                    <asp:Literal ID="Indicator_Type_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("PDP_Baseline_2016_2020") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="PDP Fulfilment:Target 2030">
                                <ItemTemplate>
                                    <asp:Literal ID="Indicator_Type_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("PDP_Fulfillment_Target_2023") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Implementation Institution">
                                <ItemTemplate>
                                    <asp:Literal ID="Implementation_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Implementing_Institution") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Intervention">
                                <ItemTemplate>
                                    <asp:Literal ID="Intervention_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Intervention_Title") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Intervention Indicator">
                                <ItemTemplate>
                                    <asp:Literal ID="InterventionIndicator_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Intervention_Indicator") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Baseline 2023/24">
                                <ItemTemplate>
                                    <asp:Literal ID="Baseline_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Baseline_2021_2024") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="2030 Term Target">
                                <ItemTemplate>
                                    <asp:Literal ID="TermTarget_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Target_2030") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Term Budget">
                                <ItemTemplate>
                                    <asp:Literal ID="Term_Budget_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Term_Budget") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="2025/26 Target">
                                <ItemTemplate>
                                    <asp:Literal ID="Target_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Target_2023") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Annual Budget">
                                <ItemTemplate>
                                    <asp:Literal ID="Annual_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Annual_Budget") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>

                            <asp:TemplateField HeaderText="Spatial Referencing">
                                <ItemTemplate>
                                    <asp:Literal ID="Spatial_Id" runat="server" Mode="PassThrough"
                                        Text='<%# Eval("Spatial_Reformulation") %>' />
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <%--<asp:BoundField DataField="Desired_Outcome" HeaderText="Desired Outcome" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center"/>
                            
                            <asp:BoundField DataField="Intervention" HeaderText="Intervention" ItemStyle-Width="150" ItemStyle-HorizontalAlign="Center"/>
                            ...
                            <%--<asp:TemplateField HeaderText="PDP Fulfilment" ItemStyle-Width="10px" >
                                <ItemTemplate>
                            ...
                            <%--<asp:TemplateField>
                                <HeaderTemplate>
                                    <span>Combined Column</span>
                                </HeaderTemplate>
                                <ItemTemplate>
                                    <%# Eval("Baseline") %> - <%# Eval("AnnualTarget") %>
                                </ItemTemplate>
                            </asp:TemplateField>--% >
                            ...
                            <asp:TemplateField HeaderText="">
                                <ItemTemplate>
                                    <table style="width: 100%; border-collapse: collapse;">
                                        <tr>
                                            <td style="width: 50%;"><%# Eval("Baseline") %></td>
                                            <td style="width: 50%;"><%# Eval("AnnualTarget") %></td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Q1" ItemStyle-Width="10px" Visible="false">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Q1" ItemStyle-Width="10px" Visible="true">
                                <ItemTemplate>
                                    <asp:Label ID="txtFA1Q1Planning1" runat="server"
                                        Text='<%# Bind("Q1Planning") %>' BorderStyle="None" Width="40px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Q1" ItemStyle-Width="10px" Visible="true">
                                <ItemTemplate>
                                    <asp:Label ID="txtFA1Q1Planning2" runat="server"
                                        Text='<%# Bind("Q1Planning") %>' BorderStyle="None" Width="40px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Q1" ItemStyle-Width="10px" Visible="true">
                                <ItemTemplate>
                                    <asp:Label ID="txtFA1Q1Planning3" runat="server"
                                        Text='<%# Bind("Q1Planning") %>' BorderStyle="None" Width="40px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Q1" ItemStyle-Width="10px" Visible="true">
                                <ItemTemplate>
                                    <asp:Label ID="txtFA1Q1Planning4" runat="server"
                                        Text='<%# Bind("Q1Planning") %>' BorderStyle="None" Width="40px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Q2" ItemStyle-Width="10px" Visible="false">
                                <ItemTemplate>
                                    <asp:Label ID="txtFA1Q2Planning" runat="server"
                                        Text='<%# Bind("Q2Planning") %>' BorderStyle="None" Width="40px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="Q3" ItemStyle-Width="10px" Visible="false">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Q4" ItemStyle-Width="10px" Visible="false">
                                <ItemTemplate>
                            ...
                            <asp:TemplateField HeaderText="Annual Archived" ItemStyle-Width="10px">
                                <ItemTemplate>
                                    <asp:Label ID="txtFA1Total11" runat="server"
                                        Text='<%# Bind("TotalValue") %>' BorderStyle="None" Width="70px"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            ...
                            <asp:TemplateField HeaderText="Edit" ItemStyle-Width="10px">
                                <ItemTemplate>
                                    <div style="padding: 5px;">
                                        <%--<asp:Button ID="btnUpdate" runat="server" Text="<i class='fas fa-sync-alt'></i> Update" CssClass="btn btn-primary"
                                           OnClick="btnUpdate_Click" />--% >

                                        <asp:Literal ID="UpdateIcon" runat="server" Text="<i class='fa fa-sync-alt'></i>" />
                            ...
                            <asp:BoundField DataField="ResponsibleInstitution" HeaderText="Responsible Institution" ItemStyle-Width="200" ItemStyle-HorizontalAlign="Center"/>
                    ...
                    <br /><br />
                    <asp:Button runat="server" ID="btnSubmitFocusArea1" OnClick="btnSubmitFocusArea1_Click" Text="Submit1" ForeColor="Black" />
                    <br /><br />


                    <%--===========================================================================================================--%>

                    <div class="modal fade" id="detailsModal" tabindex="-1" role="dialog" aria-labelledby="detailsModalLabel" aria-hidden="true" runat="server">
